...
class _GradientHalfTabIndicatorPainter extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    final double screenWidth = configuration.size!.width*1.5; // Total 2 tabs
    final bool isLeft = tabController.index == 0;

    final double indicatorWidth = screenWidth+90;
    ...
    final Rect rect = Rect.fromLTWH(
      ...
      isLeft?indicatorWidth-65:indicatorWidth+10,
      indicatorHeight,
    );
