      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDefinitionItem('Affiliate', 'means an entity that controls, is controlled by or is under common control with a party.'),
            _buildDefinitionItem('Application', 'refers to fitlit, the software program provided by the Company.'),
            _buildDefinitionItem('Company', '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to fitlit.'),
            _buildDefinitionItem('Country', 'refers to: California, United States'),
